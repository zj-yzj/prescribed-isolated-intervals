...
sections replace the powers by finite moment labels, giving polynomial
diameter for fixed $h$, and by shifted-Sidon labels when $h=2$, giving
quadratic diameter. The Sidon section also includes a lower bound showing
that quadratic diameter is the best possible order for this Sidon-label
strategy. These quantitative refinements are not needed merely to answer the
existence questions, but they make the construction less ad hoc and identify
where the real optimization problem begins.
